//
//  MvCharactersListViewModelTests.swift
//  MarvelTests
//
//  Created by Sebastian Slupski on 25/3/22.
//

import XCTest
@testable import Marvel

class MvCharactersListViewModelTests: XCTestCase {
    var sut: MvCharactersListViewModel?

    var charactersService = MvCharactersServiceMock()
    var view = MvCharactersListViewMock()

    override func setUpWithError() throws {
        sut = MvCharactersListViewModel(charactersService: charactersService)
